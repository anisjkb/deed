# src/backend/routers/get_routers.py
...
# Small helper to grab the ONE shared Jinja environment
...
def render_template(
    ...
    resp = T(request).TemplateResponse(template_name, ctx)  # ← shared env (has assetv)
...
# ──────────────────────────────────────────────────────────────
# TEAM LIST (cast enum to TEXT to match DB labels)
# ──────────────────────────────────────────────────────────────
